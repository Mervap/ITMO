var expression = (function () {
    ...
    Const.prototype = Object.create(general);
    ...
    Variable.prototype = Object.create(general);
    ...
    var OperationProt = {
        ...
        simplify: function () {
            var args = this.getOp().map(function (item) {
                return item.simplify();
            });
            var res = newOperation(this.constructor, args);

            if (args.every(function(arg) { return arg instanceof Const })) {
                return new Const(res.evaluate());
            } else if (this.doSimplify !== undefined) {
